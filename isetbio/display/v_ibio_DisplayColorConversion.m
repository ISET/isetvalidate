...
% History:
%    08/31/23  dhb  Got this to run with the isetcam branch.
%              dhb  Some validation numbers changed by about 0.3%.  Rewrote
%                   validation file with this script.
%              dhb  Edited to remove some warnings.
