% v_icam_testOTF
%
% Not sure where this comes from.  It depends on ISETBio.  It has a Nicolas
% or David feel to it.  It does not yet have asserts()
%
%

if isempty(which('isetbioRootPath')), return; end
ieInit;
