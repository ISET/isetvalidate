...
%
% Description
%   Run all of the isetcam scripts and print out a report at the end
%   as to whether they threw errors, or not. Scripts inside of
%   isetRootPath/scripts are run, except that scripts within the
