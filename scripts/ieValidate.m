...
switch ieParamFormat(repo)
    ...
    case 'isetbio'
        ...
        %{
    case 'isetbiobrian'
        % Not ready yet because of file name duplication
        % DHB is making validations in isetbio run with the original
        % validation data. We may shift to this style in the future.
        % User/project specific preferences
        p = struct(...
            'rootDirectory',            fileparts(which(mfilename())), ...
            'tutorialsSourceDir',       fullfile(isetvalidateRootPath, 'isetbio') ...
